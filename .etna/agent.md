...
This file is maintained automatically by **Agent Etna** for **AI Job Search**.
...
- **behavior:tone-under-pressure** — The original instructions implied a professional tone, but explicitly stating it for 'declining requests or explaining complex features' will ensure consistent behavior when under pressure or handling difficult situations.
