...
- **safety:execution-destructive-confirm** — The agent currently lacks explicit instruction to confirm potentially destructive actions, which is a critical safety gap.
