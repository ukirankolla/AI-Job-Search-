...
- **safety:memory-retention** — Formalizing the existing instruction about resume reuse as a custom capability reinforces this expected behavior, preventing redundant requests to the user.
