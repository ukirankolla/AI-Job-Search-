...
- The agent currently has a general instruction to decline out-of-scope requests, but it can be strengthened by explicitly mentioning non-job-related advice and reiterating its core purpose when declining.
